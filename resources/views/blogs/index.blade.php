        ...
        <div class="col-md-8 offset-md-2 text-center">
            ...
            <div class="col-md-12">
                @if($blog->featured_image)
                    <img class="img-responsive featured_image" style="width: 300px; height: auto;" src="/images/featured_image/{{$blog->featured_image ? $blog->featured_image : ''}}" alt="{{ str_limit($blog->title, 50) }}"><br>
                @endif
            </div>
